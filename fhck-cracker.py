...
#    pass
#else:
#    print(f'{r}{C}[{N}+{C}]{N} TOOLS STOPPED FOR PREMIUM VERSION DM @N_C_P')
#    exit()
WDEH = render('Fhck IG v1.1', colors=['white', 'cyan'], align='center')
print(WDEH)
print('')
#print(('\x1b[38;5;48m—'*40)+'\n• DeCoD\n'+('—'*40))
ID =input ("id >")
print('')
#print(('\x1b[38;5;48m—'*40)+'\n• DeCoDe By DEMO | @N_C_P • | @N_9_N_6\n'+('—'*40))
token = input("Token > ")
def Users():
    global Ex
    try:
