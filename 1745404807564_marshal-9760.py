...
EXECUTE_FILE = ".PY_PRIVATE/20250423161013106"
PREFIX = sys.prefix
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_b_c_d_d_l_Z_d_d_l_Z_d_d_l_m_Z_d_d, __pyx_k_c_d_d_l_Z_d_d_l_Z_d_d_l_m_Z_d_d, sizeof(__pyx_k_c_d_d_l_Z_d_d_l_Z_d_d_l_m_Z_d_d), 0, 0, 0, 0},
...
static CYTHON_SMALL_CODE int __Pyx_InitCachedConstants(void) {
  ...
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_b_c_d_d_l_Z_d_d_l_Z_d_d_l_m_Z_d_d); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 7, __pyx_L1_error)
